...
import model.dcgan_64x64
import model.dcgan_128x128
...
def generate_64x64():
  ...
  if torch.cuda.device_count() > 1:
    netG = torch.nn.DataParallel(model.dcgan_64x64.Generator())
  else:
    netG = model.dcgan_64x64.Generator()
...
def generate_128x128():
  ...
  """
  if torch.cuda.device_count() > 1:
    netG = torch.nn.DataParallel(model.dcgan_128x128.Generator())
  else:
    netG = model.dcgan_128x128.Generator()
