...
from model.wgan_gp_128x128 import Discriminator
from model.wgan_gp_128x128 import Generator
...
parser.add_argument('--netG', default='./checkpoints/wgan_gp_128x128_G.pth', help="path to netG (to continue training)")
parser.add_argument('--netD', default='./checkpoints/wgan_gp_128x128_D.pth', help="path to netD (to continue training)")
parser.add_argument('--out_images', default='./wgan_gp_128x128_imgs', help='folder to output images')
...
def main():
  ...
  for epoch in range(opt.n_epochs):
    ...
    # do checkpointing
    torch.save(netG.state_dict(), f"{opt.checkpoints_dir}/wgan_gp_128x128_G.pth")
    torch.save(netD.state_dict(), f"{opt.checkpoints_dir}/wgan_gp_128x128_D.pth")
