...
from model.wgan_128x128 import Discriminator
from model.wgan_128x128 import Generator
...
def main():
  ...
  for epoch in range(opt.n_epochs):
    ...
    # do checkpointing
    torch.save(netG.state_dict(), f"{opt.checkpoints_dir}/wgan_128x128_G.pth")
    torch.save(netD.state_dict(), f"{opt.checkpoints_dir}/wgan_128x128_D.pth")
